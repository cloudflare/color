        ...
        <Div maxWidth="48em" mx="auto" py={5}>
          ...
          >
            ...
            <Span lineHeight={1.5} display="block" mt={3}>
              Every perception of colour is an illusion.. ..we do not see
              colours as they really are. In our perception they alter one
              another. In order to use color effectively it is necessary to
              recognize that color deceives continually. In visual perception a
              ...
              <Div pl={3} pr={5} width={[1, 1 / 2]}>
                <Div style={{ overflow: "hidden" }}>
                  <BarChart width={320} height={120} data={bardata}>
                    <Bar dataKey="amt" fillOpacity={0.75} fill={data.color} />
                  </BarChart>
                </Div>
              </Div>
