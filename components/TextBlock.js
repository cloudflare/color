    ...
    >
      <Div my={0}>
        ...
        <Span fontSize={3} lineHeight={1.5} display="block" mt={3} mb={4}>
          ...
          they really are. <b>In our perception they alter one another.</b>{" "}
          <Span display={["none", "inline"]}>
            In order to use color effectively it is{" "}
            <i>necessary to recognize that color deceives continually. </i>
          </Span>
          <Span>
      ...
      <Code border="1px solid currentColor" borderRadius={3} p={3} mt={3}>
        ...
        &lt;article&gt;
        <br />
        &nbsp;&nbsp;&lt;h1&gt;A title example&lt;/h1&gt;
        <br />
        &nbsp;&nbsp;&lt;h2&gt;A subtitle example&lt;/h2&gt;
        <br />
      ...
      <Blockquote borderLeft="4px solid currentColor" ml={0} pl={3} mt={4}>
        <P fontSize={[3, 4]} mb={2} fontWeight={600}>
