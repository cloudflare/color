...
const SingleRadio = ({ label, value, population, onChange, currentValue, ...props }) => (
  <Div display="flex" alignItems="flex-start" width={1} flexWrap='wrap' mb={2} {...props}>
    <Div width='1rem' mr={1}>
      <Input
        type="radio"
    ...
    <Span ml='auto' fontSize={1} lineHeight={1.5}><b>{population}</b></Span>
  </Div>
)
  ...
  return (
    <Div display="flex" flexWrap="wrap">
      <H4 width={1} mb={2} mt={4} display='flex'>
        ...
        <Span ml='auto' fontSize={1}>Population</Span>
      </H4>
