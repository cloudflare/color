...
const IconOutlineBlock = ({ currentCombination }) => {
  ...
  return (
    ...
    >
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="remove" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="caretDown" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="caretRight" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="caretLeft" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="caretUp" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="pop" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="cost" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="creditCard" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="upload" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="exclamationOutline" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="exclamation" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="collapse" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="expand" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="file" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="forward" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="left" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="right" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="down" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="gear" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="generalInfo" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="hamburger" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="info" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="help" /></IconSolid>
      <IconSolid bg={currentCombination.bg}><Icon color={currentCombination.color} type="list" /></IconSolid>
