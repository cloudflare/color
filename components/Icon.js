...
const Icon = ({ type, color, size, ...props }) => {
  return (
    ...
    >
      ...
      {type == "backward" && (
        <Polygon color={color} points="6.846 13.616 1.23 8 6.846 2.384 6.846 4.608 4.233 7.221 14.77 7.221 14.77 8.779 4.233 8.779 6.846 11.392 6.846 13.616"/>
      )}
      {type == "left" && (
        <Polygon
          color={color}
      ...
      {type == "edit" && (
        <Path
          color={color} d="M1.715 11.418l8.91-8.911 2.828 2.828-8.91 8.911zM.8 15.3l3.1-.4-2.7-2.8zM13 .8c-.2-.2-.5-.2-.7 0l-1.1 1.1L14 4.7l1.1-1.1c.2-.2.2-.5 0-.7L13 .8z"/>
      )}
      {type == "global" && (
        <Path
          color={color}
      ...
      {type == "mail" && (
        <g>
          <Path color={color} d="M14.836,3.137a.843.843,0,0,0-.589-.236H1.753a.843.843,0,0,0-.562.213L8.036,8.656Z"/>
          <Path color={color} d="M8.037,10.261.925,4.387v7.989a.81.81,0,0,0,.828.792H14.247a.81.81,0,0,0,.828-.792V4.435Z"/>
        </g>
      )}
      {type == "refresh" && (
        <Path
      ...
      {type == "play" && <Path color={color} d="M2 2 L14 8 L2 14 z" />}
      {type == "like" && (
        <Path
          color={color}
          d="M0 5 C0 3, 1.5 1, 4 1 C6 1, 7.5 2.5, 8 3 C8.5 2.5, 10 1, 12 1 C15 1, 
        16 3, 16 5 C16 9, 9 14.5, 8 15 C7 14.5, 0 9, 0 5"
        />
      )}
      {type == "unsplash" && (
        <Path
