...
![Cloudflare.com in 2016](/thinking/cf-2016.png)

</Div>
<Div width={1/2}>

![Cloudflare.com in 2019](/thinking/cf-2019.png)
...
![The color section of our theme file was partially ordered chronologically](/thinking/cf-color-palette.png)
...
![Cloudflare.com 2017](/thinking/cf-2017.png)

</Div>
<Div width={1/2} px={1}>

![Sign in page 2017](/thinking/cf-login-2017.png)

</Div>
</Flex>

![Our app dashboard in 2017](/thinking/cf-dash-2017.png)
...
![Screenshots of pages from cloudflare.com contrasted with screenshots from our product](/thinking/cf-screenshots.png)
...
![Above - our product palette. Below - our marketing palette aligned by hue](/thinking/color-sort.png)
...
![](/thinking/palette-over-time.gif)
...
<Video src="/thinking/comparison-over-time.mp4" />
...
![Visualizing the peaks of color intensity](/thinking/peaks-of-color.png)
...
<Video src="/thinking/palette-generator.mp4" />

</Div>
<Div width={1/2} px={1}>

<Img src={`${process.env.assetPrefix}/thinking/generative-palette.png`} />
...
![](/thinking/cf-palette.png)

</Div>
<Div width={1/2} px={1}>

![Palette generator concept](/thinking/palette-generator-concept.png)

</Div>
</Flex>

![Heavily muted palette](/thinking/muted-palette.png)

![](/thinking/palette-view-concept.png)
...
![Generated palette above a set of components previewing the old and new palette for comparison](/thinking/old-vs-new.png)
...
<FigureLink
  src="/thinking/multiple-palettes-applied.png"
...
![](/thinking/random-palette.png)

<Flex alignItems='flex-start' flexWrap="wrap" mx='auto' maxWidth='64em' fontSize={[3,4,4]}>
<Div width={1/3} px={1}>

![](/thinking/palette-used-in-scene.png)

</Div>
<Div width={1/3} px={1}>

<FigureLink
  src="/thinking/example-palette-for-pixel-art.png"
...
![](/thinking/pixel-art-palette.png)

</Div>
</Flex>

<FigureLink
  src="/thinking/random-palette-1.png"
...
<Video src="/thinking/cloudflare-demo.mp4" />
...
![Brand colors showing Hue and Saturation level](/thinking/hue-and-sat-palette.png)
...
![Early iteration of palette preview during development](/thinking/early-palette-preview.png)
...
![Monitors set to different luminosity](/thinking/lum-vs-lum.jpeg)

</Div>
<Div width={1/2} px={1}>

![Close up of visual difference](/thinking/lum-vs-lum-upclose.jpeg)
...
![Optically balanced scales](/thinking/balanced-palette.png)
...
![Full theme minus green](/thinking/theme-minus-green.png)

</Div>
<Div width={1/2} px={1}>

![Blues and Oranges](/thinking/theme-blues-oranges.png)
...
![Grayscale example](/thinking/theme-grayscale.png)

</Div>
<Div width={1/2} px={1}>

![Monochromatic Indigo](/thinking/theme-indigo.png)
...
![](/thinking/chart-blue.png)

</Div>
<Div width={1/2} px={1}>

![](/thinking/chart-blue-1.png)
...
![Analytics charts with blues and purples](/thinking/charts-with-blue-purple.png)

</Div>
<Div width={1/2} px={1}>

![Analytics charts with blues and greens](/thinking/charts-blue-green.png)

</Div>
</Flex>

![Analytics charts with a blues and oranges. Telling the colors of the lines apart is a different visual experience than separating out the dots in sequential order as they appear in the legend.](/thinking/charts-blue-oranges.png)
...
<Video src="/thinking/generative-charts.mp4" />
...
![Analytics component previewed against 8 different types of color blindness](/thinking/charts-previewed.png)
...
![Optically balanced scale](/thinking/contrast-score.png)

![Palette preview as both fully saturated and desaturated](/thinking/palette-desaturated.png)
...
![A visual representation of how the legacy palette colors would translate to the new scales.](/thinking/palette-migration.png)
...
<Video src="/thinking/fetch-palette.mp4" />
...
![Example of console warning when using deprecated color](/thinking/invalid-colors.png)

![Example of how to check for usage of deprecated values](/thinking/invalid-colors-code.png)
...
![cloudflarestatus.com in 2017](/thinking/cloudflare-status-2017.png)

</Div>
<Div width={1/2} px={1}>

![cloudflarestatus.com in 2019 with an accessible green](/thinking/cloudflare-status-2019.png)
...
![Notifications 2017 - Black text](/thinking/cf-notifications-2017.png)

</Div>
<Div width={1/2} px={1}>

![Notifications 2018 - Updated palette. Text is set to 1st step in corresponding scale of background color.](/thinking/cf-notifications-2018.png)

</Div>
</Flex>

![Example page within our Dashboard in 2017 vs 2019](/thinking/2017-2019.png)
...
![Cloudflare homepage](/thinking/cf-home-2019.png)

</Div>
<Div width={1/2} px={1}>

![Updated account dashboard](/thinking/cf-accounts-2019.png)

</Div>
</Flex>

![Updated site dashboard](/thinking/cf-dash-2019.png)
