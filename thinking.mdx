...
<video style={{ maxWidth: "100%" }} autoPlay loop muted playsInline>
  <source
    src={`${process.env.assetPrefix}/static/thinking/comparison-over-time.mp4`}
    type="video/mp4"
  />
</video>
...
<video style={{ maxWidth: "100%" }} autoPlay loop muted playsInline>
  <source
    src={`${process.env.assetPrefix}/static/thinking/colors.mp4`}
    type="video/mp4"
  />
</video>
...
<video style={{ maxWidth: "100%" }} autoPlay loop muted playsInline>
  <source
    src={`${process.env.assetPrefix}/static/thinking/palette-generator.mp4`}
    type="video/mp4"
  />
</video>

![](/static/thinking/generative-palette.png)
...
<video style={{ maxWidth: "100%" }} autoPlay loop muted playsInline>
  <source
    src={`${process.env.assetPrefix}/static/thinking/cloudflare-demo.mp4`}
    type="video/mp4"
  />
</video>
...
<video style={{ maxWidth: "100%" }} autoPlay loop muted playsInline>
  <source
    src={`${process.env.assetPrefix}/static/thinking/generative-charts.mp4`}
    type="video/mp4"
  />
</video>
...
[Lyft’s writeup](https://design.lyft.com/re-approaching-color-9e604ba22c88and)

[**“Re-approaching color”**](https://design.lyft.com/re-approaching-color-9e604ba22c88and) and [Jeeyoung Jung’s “](https://uxplanet.org/designing-systematic-colors-b5d2605b15c)[**Designing Systematic Colors**](https://uxplanet.org/designing-systematic-colors-b5d2605b15c)[”](https://uxplanet.org/designing-systematic-colors-b5d2605b15c) are some of the best write-ups on how to work with color at scale you can find.
...
<video style={{ maxWidth: "100%" }} autoPlay loop muted playsInline>
  <source
    src={`${process.env.assetPrefix}/static/thinking/fetch-palette.mp4`}
    type="video/mp4"
  />
</video>
