...
![](/static/about/preview-panel-1.png)

![](/static/about/preview-panel-2.png)

![](/static/about/preview-panel-3.png)

![](/static/about/preview-panel-4.png)

![](/static/about/preview-panel-5.png)

![](/static/about/preview-panel-6.png)
...
<video style={{ maxWidth: "100%" }} autoPlay loop muted playsInline>
  <source
    src={`${process.env.assetPrefix}/static/about/workers.mp4`}
    type="video/mp4"
  />
</video>
...
<video style={{ maxWidth: "100%" }} autoPlay loop muted playsInline>
  <source
    src={`${process.env.assetPrefix}/static/about/importcolors.mp4`}
    type="video/mp4"
  />
</video>
